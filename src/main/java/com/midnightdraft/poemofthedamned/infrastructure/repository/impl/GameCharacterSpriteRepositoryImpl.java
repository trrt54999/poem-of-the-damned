...
@Slf4j
public class GameCharacterSpriteRepositoryImpl extends
    BaseRepositoryImpl<GameCharacterSprite> implements
  ...
  @Override
  public Optional<GameCharacterSprite> findByCharacterIdAndEmotion(Long characterId,
      String emotion) {
    try (Session session = HibernateSessionFactory.getSessionFactory().openSession()) {
      ...
      log.error("Failed to fetch GameCharacterSprite by characterId: {} and emotion: {}",
          characterId, emotion, e);
