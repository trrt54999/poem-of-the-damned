...
-- DIALOGUES(Scene 2)
INSERT INTO dialogues (id, order_index, text, game_scene_id, ambient_path, created_at, updated_at) VALUES (8, 1, 'I entered the classroom and quickly looked around, it seemed like I didn`t know anyone at all... Trouble...', 2, 'SCHOOL_HALLWAY', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO dialogues (id, order_index, text, game_scene_id, created_at, updated_at) VALUES (37, 28, 'Emm...', 3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dialogues (id, order_index, sprite_position, character_id, character_sprite_id, text, game_scene_id, created_at, updated_at) VALUES (38, 29, 'LEFT', 2, 7, 'Never mind...', 3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dialogues (id, order_index, text, game_scene_id, created_at, updated_at) VALUES (39, 30, 'She`s... rather... strange.', 3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO dialogues (id, order_index, text, game_scene_id, created_at, updated_at) VALUES (46, 1, 'After class, I decided to take a walk on the roof. I liked eating lunch here, but even here I wasn`t left in peace...', 4, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dialogues (id, order_index, sprite_position, character_id, character_sprite_id, text, game_scene_id, created_at, updated_at) VALUES (47, 2, 'CENTRAL', 1, 1, 'Oh, hello again!', 4, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dialogues (id, order_index, text, game_scene_id, created_at, updated_at) VALUES (48, 3, 'Whoa! Haruka, you scared me! What are you doing here??', 4, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dialogues (id, order_index, sprite_position, character_id, character_sprite_id, text, game_scene_id, created_at, updated_at) VALUES (49, 4, 'CENTRAL', 1, 1, 'Hahaha! Sorry, it`s pretty boring in the student council, so I decided to take a walk...', 4, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dialogues (id, order_index, sprite_position, character_id, character_sprite_id, text, game_scene_id, created_at, updated_at) VALUES (50, 5, 'CENTRAL', 1, 8, 'By the way, did you talk to anyone from class after the lesson?', 4, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dialogues (id, order_index, text, game_scene_id, created_at, updated_at) VALUES (51, 6, 'Umm... you know, I`m not really into making friends...', 4, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dialogues (id, order_index, sprite_position, character_id, character_sprite_id, text, game_scene_id, created_at, updated_at) VALUES (52, 7, 'CENTRAL', 1, 9, 'Whaaat??? Yeah, we need to fix that...', 4, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dialogues (id, order_index, text, game_scene_id, created_at, updated_at) VALUES (53, 8, 'I just said, I`m not really into it...', 4, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dialogues (id, order_index, sprite_position, character_id, character_sprite_id, text, game_scene_id, created_at, updated_at) VALUES (54, 9, 'CENTRAL', 1, 1, 'Ha! I`m not taking no for an answer! Let`s go, I`ll show you my friends` clubs!', 4, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dialogues (id, order_index, text, game_scene_id, created_at, updated_at) VALUES (55, 10, 'Let`s not do this today, we won`t have time anyway...', 4, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dialogues (id, order_index, sprite_position, character_id, character_sprite_id, text, game_scene_id, created_at, updated_at) VALUES (56, 11, 'CENTRAL', 1, 2, 'Okay, but tomorrow you won`t escape me!', 4, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dialogues (id, order_index, text, game_scene_id, created_at, updated_at) VALUES (57, 12, 'Fine, fine... see ya.', 4, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dialogues (id, order_index, sprite_position, character_id, character_sprite_id, text, game_scene_id, created_at, updated_at) VALUES (58, 13, 'CENTRAL', 1, 1, 'See you tomorrow! I`ve got my eye on you!', 4, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dialogues (id, order_index, text, game_scene_id, created_at, updated_at) VALUES (59, 14, 'Was she always this energetic? I used to think the student council president was all about rules and boredom. But she acts like we`re... childhood friends.', 4, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- DIALOGUES (Scene 5 - Class Evening)
INSERT INTO dialogues (id, order_index, text, game_scene_id, created_at, updated_at) VALUES (60, 1, 'Classes are finally over. The setting sun bathed the empty classroom in thick orange light.', 5, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dialogues (id, order_index, text, game_scene_id, created_at, updated_at) VALUES (61, 2, 'I slowly packed my textbooks into my bag, enjoying this sudden silence after a noisy day.', 5, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dialogues (id, order_index, text, game_scene_id, created_at, updated_at) VALUES (62, 3, 'Aya, Mio... and Haruka.', 5, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dialogues (id, order_index, text, game_scene_id, created_at, updated_at) VALUES (63, 4, 'Aya seems so fragile. Like if you speak just a bit too loudly, she`ll shatter like porcelain. And those words of hers about withered flowers...', 5, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dialogues (id, order_index, text, game_scene_id, created_at, updated_at) VALUES (64, 5, 'And Mio... She didn`t even look at me properly. Just evaluated me. As if she was listening to my heartbeat, deciding whether it was too loud.', 5, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dialogues (id, order_index, text, game_scene_id, created_at, updated_at) VALUES (65, 6, 'Suddenly, my gaze fell on Haruka`s desk.', 5, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dialogues (id, order_index, text, game_scene_id, created_at, updated_at) VALUES (66, 7, 'Strange. She left first, supposedly because of student council business, but her notebook and pen are still lying here.', 5, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dialogues (id, order_index, text, game_scene_id, created_at, updated_at) VALUES (67, 8, 'She was always so put together... Maybe she just forgot?', 5, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dialogues (id, order_index, text, game_scene_id, created_at, updated_at) VALUES (68, 9, 'Never mind... I decided not to pry into other people`s business, slung my bag over my shoulder, and left the classroom.', 5, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- DIALOGUES (Scene 6 - Street Evening)
INSERT INTO dialogues (id, order_index, text, game_scene_id, created_at, updated_at) VALUES (69, 1, 'The evening air was pleasantly cool. The streetlights were already turning on.', 6, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dialogues (id, order_index, text, game_scene_id, created_at, updated_at) VALUES (70, 2, 'Usually, the first day of school blends into one gray blur. But today... today everything felt too vivid. Too much attention on me.', 6, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dialogues (id, order_index, text, game_scene_id, created_at, updated_at) VALUES (71, 3, 'I feel like the main character of some manga... hah, funny.', 6, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- DIALOGUES (Scene 7 - Room Night)
INSERT INTO dialogues (id, order_index, text, game_scene_id, created_at, updated_at) VALUES (72, 1, 'I collapsed onto the bed without even changing clothes. Exhaustion crashed down on me with all its weight.', 7, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dialogues (id, order_index, text, game_scene_id, created_at, updated_at) VALUES (73, 2, 'Finally home. It`s quiet here. It`s safe here.', 7, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dialogues (id, order_index, text, game_scene_id, created_at, updated_at) VALUES (74, 3, 'Tomorrow Haruka promised to drag me around the clubs... The music club, where that silent Mio hangs out. And the literature club, where Aya reads her depressing books.', 7, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dialogues (id, order_index, text, game_scene_id, created_at, updated_at) VALUES (75, 4, 'Where would I rather go?', 7, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dialogues (id, order_index, text, game_scene_id, created_at, updated_at) VALUES (76, 5, 'Honestly, nowhere. But it seems I won`t have a choice. Haruka isn`t the type to take no for an answer.', 7, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dialogues (id, order_index, text, game_scene_id, created_at, updated_at) VALUES (77, 6, 'Tomorrow will be a long day. I just need to sleep. Just sleep...', 7, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);